...
3. If the external HUD pack uses conflicting text shaders, remove or disable that external shader configuration. Oraxen no longer provides a `TextEffects` setting. <Highlight color="#e74c3c">**Optional**</Highlight>
